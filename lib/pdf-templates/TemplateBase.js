...
export const createResumeTemplate = (config) => {
    ...
    const styles = StyleSheet.create({
        ...
        header: {
            ...
            paddingBottom: 10,
            borderBottomWidth: 1,
            borderBottomColor: PROFESSIONAL_COLORS.green,
        },
        headerContent: {
            flexDirection: 'row',
        ...
        name: {
            ...
            fontWeight: 'bold',
            marginBottom: 3,
            color: PROFESSIONAL_COLORS.green,
            textTransform: 'none',
        },
        title: {
                    ...
                    {skills && Object.keys(skills).length > 0 && (
                        <View style={styles.section}>
                            ...
                            {Object.entries(skills).map(([category, skillList], idx) => (
                                <View key={idx} style={[styles.skillsCategory, { flexDirection: 'row', flexWrap: 'wrap' , alignItems: 'flex-start'}]}>
